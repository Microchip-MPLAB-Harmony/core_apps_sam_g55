...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html#i2c-driver-asynchronous---i2c-multi-slave",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_multi_slave/readme.html#running-the-application"
  },"6": {
    "doc": "I2C driver asynchronous - I2C multi slave",
    "title": "I2C driver asynchronous - I2C multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html",
    ...
    "content": "This example application demonstrates how to use the I2C driver in synchronous mode to perform read/write operations on an EEPROM. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom"
  },"8": {
    "doc": "I2C Driver Synchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode to communicate with an EEPROM to perform read and write operations. The application communicates with the EEPROM 3 click board that has AT24CM02 EEPROM on it. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html#description",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#description"
  },"9": {
    "doc": "I2C Driver Synchronous - I2C EEPROM",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/sync/i2c_eeprom/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_g55_xpro_freertos.X | MPLABX project for SAM G55 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "I2C Driver Synchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro_freertos.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | EEPROM 3 click board | mikroBUS Xplained Pro board | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install an EEPROM 3 click board on the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header of the SAM G55 Xplained Pro Evaluation Kit | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "I2C Driver Synchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE. | The LED indicates the success or failure. | The LED is turned ON when the data read from EEPROM matches with the written data | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application"
  },"12": {
    "doc": "I2C Driver Synchronous - I2C EEPROM",
    "title": "I2C Driver Synchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html"
  },"13": {
    "doc": "I2C Driver Synchronous - I2C multi slave",
    "title": "I2C Driver Synchronous - I2C multi slave",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html#i2c-driver-synchronous---i2c-multi-slave",
    "relUrl": "/apps/driver/i2c/sync/i2c_multi_slave/readme.html#i2c-driver-synchronous---i2c-multi-slave"
  },"14": {
    "doc": "I2C Driver Synchronous - I2C multi slave",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode and demonstrates the multi-client feature. The application uses a IO1 Xplained Pro Extension Kit that has a temperature sensor and an EEPROM, both interfaced on the same I2C bus. Two application threads are created which act as clients to the same instance of the I2C driver: . APP_I2C_TEMP_SENSOR_Tasks: . This task remains in blocked state for 1 second. Once unblocked, it reads the temperature from the temperature sensor and posts a semaphore thereby unblocking the second (EEPROM) thread. APP_I2C_EEPROM_Tasks: . This task remains blocked on a semaphore until a new temperature data is available. Once unblocked, it writes the temperature data to the EEPROM. It also reads and prints the last five saved temperature values from the EEPROM when user inputs a key on the console. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_multi_slave/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "I2C Driver Synchronous - I2C multi slave",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro_freertos.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | IO1 Xplained Pro Extension Kit | . | The A2 address line of TWI must be soldered to GND. This is done to modify the address of the the EEPROM on IO1 Xplained Pro Extension Kit. The modification changes the address of the temperature sensor to 0x4B and the EEPROM to 0x50 . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect the IO1 Xplained Pro Extension Kit to the EXT1 header of the SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/sync/i2c_multi_slave/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "I2C Driver Synchronous - I2C multi slave",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer. Configure the DEBUG port settings as follows: . Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build and program the application using its IDE. | Observe the temperature values getting printed on the terminal application every 1 second and temperature value written into EEPROM notification as shown below: | Press any key on the terminal, last 5 temperature values will be read from the EEPROM and displayed as shown below. | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_multi_slave/readme.html#running-the-application"
  },"18": {
    "doc": "I2C Driver Synchronous - I2C multi slave",
    "title": "I2C Driver Synchronous - I2C multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#i2c-eeprom-driver---at24-eeprom-read-write",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"22": {
    "doc": "I2C EEPROM driver - AT24 EEPROM read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | EEPROM 3 click board | mikroBUS Xplained Pro board | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install an EEPROM 3 click board on to the mikroBUS Xplained Pro board . | Connect the mikroBUS Xplained Pro board to the EXT1 header of the SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "I2C EEPROM driver - AT24 EEPROM read write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE. | The LED indicates the success or failure. | The LED is turned ON when the data read from EEPROM matches with the written data | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application"
  },"24": {
    "doc": "I2C EEPROM driver - AT24 EEPROM read write",
    "title": "I2C EEPROM driver - AT24 EEPROM read write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html"
  },"25": {
    "doc": "SPI driver asynchronous - SPI multi slave",
    "title": "SPI driver asynchronous - SPI multi slave",
    "content": "This example application demonstrates the multi client feature of the asynchronous mode of the SPI driver by reading and writing to two EEPROMs connected to the same SPI bus. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html#spi-driver-asynchronous---spi-multi-slave",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#spi-driver-asynchronous---spi-multi-slave"
  },"26": {
    "doc": "SPI driver asynchronous - SPI multi slave",
    "title": "Description",
    "content": "This application uses the asynchronous mode of the SPI driver and demonstrates the multi client feature by reading and writing to two EEPROMs connected to the same SPI bus. The example also demonstrates how to setup two different client transfers at two different baud rates. The application communicates with two EEPROM 4 click boards that has AT24CM02 EEPROM on it. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "SPI driver asynchronous - SPI multi slave",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | Two EEPROM 4 click boards | Two mikroBUS Xplained Pro boards | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install EEPROM 4 click boards on the mikroBUS Xplained Pro boards . | Connect the mikroBUS Xplained Pro boards on EXT1 and EXT3 headers of the SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "SPI driver asynchronous - SPI multi slave",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE. | The LED indicates success or failure. | The LED turns ON when the data read from the EEPROMs matches with the data written to the EEPROMs. | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application"
  },"30": {
    "doc": "SPI driver asynchronous - SPI multi slave",
    "title": "SPI driver asynchronous - SPI multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html"
  },"31": {
    "doc": "SPI Driver Synchronous - Spi multi slave",
    "title": "SPI Driver Synchronous - Spi multi slave",
    "content": "This example application demonstrates the multi client feature of the synchronous mode of the SPI driver by reading and writing to two EEPROMs connected to the same SPI bus. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html#spi-driver-synchronous---spi-multi-slave",
    "relUrl": "/apps/driver/spi/sync/spi_multi_slave/readme.html#spi-driver-synchronous---spi-multi-slave"
  },"32": {
    "doc": "SPI Driver Synchronous - Spi multi slave",
    "title": "Description",
    "content": "The application uses the synchronous mode of the SPI driver and demonstrates the multi client feature by reading and writing to two EEPROMs connected to the same SPI bus. The example also demonstrates how to setup two different client transfers at two different baud rates. The example has three RTOS threads for the purpose: . APP_EEPROM1_Tasks: This thread performs write-read operation on the first EEPROM APP_EEPROM2_Tasks: This thread performs write-read operation on the second EEPROM APP_MONITOR_Tasks: This thread checks the status of the EEPROM transfers and turns on the LED if the transfers are successful . The application communicates with two EEPROM 4 click boards that has AT24CM02 EEPROM on it. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_multi_slave/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "SPI Driver Synchronous - Spi multi slave",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro_freertos.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | Two EEPROM 4 click boards | Two mikroBUS Xplained Pro boards | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install EEPROM 4 click boards on the mikroBUS Xplained Pro boards . | Connect the mikroBUS Xplained Pro boards on EXT1 and EXT3 headers of the SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/sync/spi_multi_slave/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "SPI Driver Synchronous - Spi multi slave",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE. | The LED indicates success or failure. | The LED turns ON when the data read from the EEPROMs matches with the data written to the EEPROMs. | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_multi_slave/readme.html#running-the-application"
  },"36": {
    "doc": "SPI Driver Synchronous - Spi multi slave",
    "title": "SPI Driver Synchronous - Spi multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#spi-eeprom-driver---at25-eeprom-read-write",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "SPI EEPROM driver - AT25 EEPROM read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | EEPROM 4 click board | mikroBUS Xplained Pro board | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install EEPROM 4 click board on the mikroBUS Xplained Pro board . | Connect the mikroBUS Xplained Pro boards on EXT1 header of the SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "SPI EEPROM driver - AT25 EEPROM read write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE. | The LED indicates success or failure. | The LED is turned ON when the value read from EEPROM matches with the written data | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application"
  },"42": {
    "doc": "SPI EEPROM driver - AT25 EEPROM read write",
    "title": "SPI EEPROM driver - AT25 EEPROM read write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"52": {
    "doc": "USART Driver Synchronous - Usart echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro_freertos.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"53": {
    "doc": "USART Driver Synchronous - Usart echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera Term) on the computer. | Configure the serial port settings as follows: Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build and program the application using its IDE. | Type a character and observe the output on the console as shown below: . | On success, the character typed is echoed back and an LED toggles each time a character is echoed. | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"54": {
    "doc": "USART Driver Synchronous - Usart echo",
    "title": "USART Driver Synchronous - Usart echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application"
  },"58": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"59": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for LED and Switch name: . | Board | LED Name | Switch Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | SW0 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"60": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/nvm_fat/readme.html",
    "relUrl": "/apps/fs/nvm_fat/readme.html"
  },"61": {
    "doc": "FAT filesystem using SDSPI driver and SPI PLIB",
    "title": "FAT filesystem using SDSPI driver and SPI PLIB",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html#fat-filesystem-using-sdspi-driver-and-spi-plib",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#fat-filesystem-using-sdspi-driver-and-spi-plib"
  },"62": {
    "doc": "FAT filesystem using SDSPI driver and SPI PLIB",
    "title": "Description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application"
  },"64": {
    "doc": "FAT filesystem using SDSPI driver and SPI PLIB",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro_freertos.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | IO1 Xplained Pro Extension Kit | One micro-sd card. Create a new JPEG file in the SD Card with name FILE_TOO_LONG_NAME_EXAMPLE_123.JPG | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect IO1 Xplained Pro Extension Kit to the EXT1 header of SAM G55 Xplained Pro Evaluation Kit . | Insert the micro-SD Card in the micro-SD Card slot of the IO1 Xplained Pro Extension Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#running-the-application"
  },"66": {
    "doc": "FAT filesystem using SDSPI driver and SPI PLIB",
    "title": "FAT filesystem using SDSPI driver and SPI PLIB",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html",
    "relUrl": "/apps/fs/sdspi_fat/readme.html"
  },"67": {
    "doc": "EEPROM Emulator library read write",
    "title": "EEPROM Emulator library read write",
    "content": "This application example demonstrates how to read and write to the Emulated EEPROM memory space using the EEPROM Emulator library. ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#eeprom-emulator-library-read-write",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#eeprom-emulator-library-read-write"
  },"68": {
    "doc": "EEPROM Emulator library read write",
    "title": "Description",
    "content": "This example uses EEPROM Emulator library to read and write to the Emulated EEPROM memory space. The application first checks if the library was initialized successfully or not. When running the application for the first time, the EEPROM Emulator memory space will be formatted by the application. The application then writes data to EEPROM memory space using the APIs provided by the EEPROM Emulator library and then reads the data back and compares it with the written data. lding the application . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#description",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#description"
  },"69": {
    "doc": "EEPROM Emulator library read write",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/library/eeprom_emulator/eeprom_emulator_read_write/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_g55_xpro.X | MPLABX project for SAM G55 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#downloading-and-building-the-application"
  },"70": {
    "doc": "EEPROM Emulator library read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM G55 Xplained Pro Evaluation Kit . | No additional hardware is required to run this demo | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#setting-up-the-hardware"
  },"71": {
    "doc": "EEPROM Emulator library read write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Connect the Debug USB port on the board to the computer using a micro USB cable | LED is turned ON when when the value read from the Emulated EEPROM memory region matches with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#running-the-application",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html#running-the-application"
  },"72": {
    "doc": "EEPROM Emulator library read write",
    "title": "EEPROM Emulator library read write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html",
    "relUrl": "/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html"
  },"73": {
    "doc": "FreeRTOS basic",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html#freertos-basic",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application"
  },"76": {
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application"
  },"78": {
    "doc": "FreeRTOS basic",
    "title": "FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html#time-system-service-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application"
  },"82": {
    "doc": "Time System Service multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html#running-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#running-the-application"
  },"84": {
    "doc": "Time System Service multi client",
    "title": "Time System Service multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"88": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_g55_xpro.X | SAM G55 Xplained Pro Evaluation Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | EEPROM 3 click board | mikroBUS Xplained Pro board | . | . Setting up SAM G55 Xplained Pro Evaluation Kit . | Install an EEPROM 3 click board on to the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header of the SAM G55 Xplained Pro Evaluation Kit | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"89": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Connect the Debug USB port on the board to the computer using a micro USB cable | The LED indicates the success or failure. The LED is turned ON when the data read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM G55 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application"
  },"90": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "I2C driver asynchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html"
  },"91": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"92": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM G55 family  v3.4.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM G55 Xplained Pro Evaluation Kit | 15 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v340",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v340"
  },"93": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM G55 family  v3.3.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM G55 Xplained Pro Evaluation Kit | 15 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v330",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v330"
  },"94": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM G55 family  v3.2.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM G55 Xplained Pro Evaluation Kit | 15 | . New Features . | All MPLAB X applications are updated to work with both MHC and MCC tools | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v320",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v320"
  },"95": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM G55 family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM G55 Xplained Pro Evaluation Kit | 14 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v310",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-g55-family--v310"
  },"96": {
    "doc": "Release notes",
    "title": "Harmony 3 driver and system service application examples for SAM G55 family  v3.0.1",
    ...
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-g55-family--v301",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-g55-family--v301"
  },"97": {
    "doc": "Release notes",
    "title": "Harmony 3 driver and system service application examples for SAM G55 family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM G55 Xplained Pro Evaluation Kit | 14 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for SAM G55 development boards | . Known Issues . The current known issues are as follows: . | None | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-g55-family--v300",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-g55-family--v300"
  },"98": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_g55/release_notes.html",
    "relUrl": "/release_notes.html"
  },"99": {
    "doc": "Harmony 3 driver and system service application examples for SAM G55 family",
    "title": "Harmony 3 driver and system service application examples for SAM G55 family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for SAM G55 family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for SAM G55 family - [Release Notes](/core_apps_sam_g55/release_notes.html) - [MPLAB® Harmony License](/core_apps_sam_g55/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_g55) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_sam_g55/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver asynchronous - I2C EEPROM](/core_apps_sam_g55/apps/driver/i2c/async/i2c_eeprom/readme.html) | This example application demonstrates how to use the I2C driver in asynchronous mode to perform read/write operations on an EEPROM | [I2C driver asynchronous - I2C multi slave](/core_apps_sam_g55/apps/driver/i2c/async/i2c_multi_slave/readme.html) | This example application demonstrates the multi-client feature of the asynchronous mode of the I2C driver by communicating with an external EEPROM and a temperature sensor | [I2C Driver Synchronous - I2C EEPROM](/core_apps_sam_g55/apps/driver/i2c/sync/i2c_eeprom/readme.html) | This example application demonstrates how to use the I2C driver in synchronous mode to perform read/write operations on an EEPROM | [I2C Driver Synchronous - I2C multi slave](/core_apps_sam_g55/apps/driver/i2c/sync/i2c_multi_slave/readme.html) | This example application demonstrates the multi-client feature of the synchronous mode of the I2C driver by communicating with an external EEPROM and a temperature sensor | [I2C EEPROM driver - AT24 EEPROM read write](/core_apps_sam_g55/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html) | This example application demonstrates how to use the AT24 driver to perform read and write operations on AT24 series of EEPROM | [SPI driver asynchronous - SPI multi slave](/core_apps_sam_g55/apps/driver/spi/async/spi_multi_slave/readme.html) | This example application demonstrates the multi client feature of the asynchronous mode of the SPI driver by reading and writing to two EEPROMs connected to the same SPI bus | [SPI Driver Synchronous - Spi multi slave](/core_apps_sam_g55/apps/driver/spi/sync/spi_multi_slave/readme.html) | This example application demonstrates the multi client feature of the synchronous mode of the SPI driver by reading and writing to two EEPROMs connected to the same SPI bus | [SPI EEPROM driver - AT25 EEPROM read write](/core_apps_sam_g55/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html) | This example application demonstrates how to use the AT25 driver to perform read and write operations on AT25 series of EEPROM | [USART driver asynchronous - USART Echo](/core_apps_sam_g55/apps/driver/usart/async/usart_echo/readme.html) | This example application demonstrates the asynchronous mode of the USART driver by echoing the received characters | [USART Driver Synchronous - Usart echo](/core_apps_sam_g55/apps/driver/usart/sync/usart_echo/readme.html) | This example application demonstrates the synchronous mode of the USART driver by echoing the received characters | [FAT filesystem using NVM Media](/core_apps_sam_g55/apps/fs/nvm_fat/readme.html) | This application shows an example of implementing a FAT disk in the device internal Flash memory | [FAT filesystem using SDSPI driver and SPI PLIB](/core_apps_sam_g55/apps/fs/sdspi_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDSPI driver and the SPI PLIB | [EEPROM Emulator library read write](/core_apps_sam_g55/apps/library/eeprom_emulator/eeprom_emulator_read_write/readme.html) | This application example demonstrates how to read and write to the Emulated EEPROM memory space using the EEPROM Emulator library | [FreeRTOS basic](/core_apps_sam_g55/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between four tasks of different priorites. Two tasks run periodically while the other two tasks are event driven | [Time System Service multi client](/core_apps_sam_g55/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_g55/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_g55/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_g55/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_g55/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_sam_g55.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_sam_g55/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_sam_g55";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for SAM G55 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_sam_g55/assets/css/just-the-docs-' + theme + '.css');
}
